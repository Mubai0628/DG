# MCP Tool Invocation Proposal RC Checklist
...
Follow `docs/mcp-tool-invocation-proposal-manual-qa.md`.
...
mutating MCP tool proposal code.
...
Use `docs/release-notes-v0.19.0-mcp-tool-invocation-proposal-rc.1.md`.

When writing the GitHub Release body, use full docs path links such as
`https://github.com/Mubai0628/DG/blob/v0.19.0-mcp-tool-invocation-proposal-rc.1/docs/mcp-tool-invocation-proposal-manual-qa.md`.
